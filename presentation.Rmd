...
author: "STAT 405 - Vivian Zheng, Tyler Braito, Calvin Aberg, Mattia Saladini, and
  Ndidi Nwosu"
...
#Loading data:
# setwd("C:/Users/tyler/OneDrive/Desktop/stat405-project")
library(ggplot2)
library(dplyr)
library(ggthemes)
library(RSQLite)
...
weatherTable <- read.csv(paste0("C:/Users/tyler/OneDrive/Desktop/stat405-project/Washington,DC,USA weather 2022-08-01 to 2022-08-31.csv"))
dbWriteTable(conn = dcon, name = "AugustWeather", 
             weatherTable, append = TRUE, row.names = FALSE)
dbListTables(dcon)
bike_dta <- read.csv("C:/Users/tyler/Downloads/202208-capitalbikeshare-tripdata.csv", header = TRUE, sep = ",")
...
## Barplots of Distance Ridden by Type of Bike
...
ui <- fluidPage(
   ...
   sidebarLayout(
      ...
      selectInput(inputId ="starter_station",
                  ...
                  names(sort(table(bike_dta$start_station_name), decreasing= TRUE))[1:10],
                  selected = NULL
      )
      ),
...
server <- function(input, output) {
     ...
     starter_station <- input$starter_station
     highlighted <- input$highlighted
     
     killer_plot(df = bike_prepped, station_name = starter_station, highlighted)
