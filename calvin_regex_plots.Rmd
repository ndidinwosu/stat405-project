...
table <- Washington_DC_USA_weather_2022_08_01_to_2022_08_31
dbWriteTable(conn = dcon, name = "weather", 
             table, append = TRUE, row.names = FALSE)
dbListTables(dcon)
table2 <- read.csv("C:/Users/calvi/Downloads/202208-capitalbikeshare-tripdata/202208-capitalbikeshare-tripdata.csv")
